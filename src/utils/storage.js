...
function notifyNative() {
  try {
    ...
    const payload = {
      ...
      latestJap: latest?.japanese ? latest.japanese.reading + latest.japanese.listening : null,
      latestComp: latest?.comprehensive?.score ?? null,
  ...
  const samples = [
    {
      ...
      japanese: { reading: 148, listening: 130, wrongQuestions: { reading: [3, 7, 12, 18, 25, 30, 33], listening: [2, 8, 15, 22, 35] } },
    ...
    },
    {
      ...
      japanese: { reading: 164, listening: 138, wrongQuestions: { reading: [7, 12, 20, 28], listening: [5, 15, 22, 30, 38] } },
    ...
    },
    {
      ...
      japanese: { reading: 172, listening: 150, wrongQuestions: { reading: [7, 18, 25], listening: [15, 22, 30] } },
    ...
    },
    {
      ...
      japanese: { reading: 180, listening: 158, wrongQuestions: { reading: [18, 25], listening: [22, 30] } },
